...
class Usuario():
    def __init__(self, correo: str, contraseña: str) -> None:
        ...
        self.__amigos = [] #lista vacía de amigos por defecto
    ...
    ## habría que implementar los métodos para obtener los datos de algún amigo, por
    ## ejemplo si interactúa con sus fotos, other se asume como Usuario
    
    def agregar_amigos(self, other) -> None:
        self.__amigos.append(other)
